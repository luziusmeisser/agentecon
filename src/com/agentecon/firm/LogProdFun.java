...
public class LogProdFun implements IProductionFunction {
	...
	public LogProdFun(Good output, double italianWeight) {
		this(output, new Weight(SimConfig.ITALTIME, italianWeight), new Weight(SimConfig.SWISSTIME, 10 - italianWeight));
	}
