...
public class LogUtilTest {
	...
	public void testLogUtil(){
		LogUtil util = new LogUtil(new Weight(PIZZA, 8.0), new Weight(FONDUE, 2.0), new Weight(SWISSTIME, 14.0));
	...
	public void testLogUtil2(){
		LogUtil util = new LogUtil(new Weight(PIZZA, 8.0), new Weight(SWISSTIME, 14.0));
		assert util.getUtility(Collections.<IStock>emptyList()) == 0.0;
